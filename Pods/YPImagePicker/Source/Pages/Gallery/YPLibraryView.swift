...
final class YPLibraryView: UIView {
    ...
    @IBOutlet var assetZoomableView: YPAssetZoomableView!
    @IBOutlet var assetViewContainer: YPAssetViewContainer!
    @IBOutlet var assetViewContainerConstraintTop: NSLayoutConstraint!
