...
public class YPVideoFiltersVC: UIViewController, IsMediaFilterVC {
    @IBOutlet var trimBottomItem: YPMenuItem!
    @IBOutlet var coverBottomItem: YPMenuItem!

    @IBOutlet var videoView: YPVideoView!
    @IBOutlet var trimmerView: TrimmerView!

    @IBOutlet var coverImageView: UIImageView!
    @IBOutlet var coverThumbSelectorView: ThumbSelectorView!
    ...
    @objc func itemDidFinishPlaying(_: Notification) {
        if let startTime = trimmerView.startTime {
