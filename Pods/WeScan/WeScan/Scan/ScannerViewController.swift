...
final class ScannerViewController: UIViewController {
    ...
    @objc private func captureImage(_: UIButton) {
...
extension ScannerViewController: RectangleDetectionDelegateProtocol {
    func captureSessionManager(_: CaptureSessionManager, didFailWithError error: Error) {
    ...
    func captureSessionManager(_: CaptureSessionManager, didCapturePicture picture: UIImage, withQuad quad: Quadrilateral?) {
        activityIndicator.stopAnimating()
    ...
    func captureSessionManager(_: CaptureSessionManager, didDetectQuad quad: Quadrilateral?, _ imageSize: CGSize) {
